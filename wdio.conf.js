exports.config = {
    ...
    cucumberOpts: {
        require: ['./features/step_definitions/given.js', './features/step_definitions/when.js', './features/step_definitions/then.js'],        // <string[]> (file/dir) require files before executing features
